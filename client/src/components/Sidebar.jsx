              ...
              >
                <div className="flex justify-between items-center w-full gap-2">
                  <div className="flex items-center gap-2 overflow-hidden flex-1">
                    ...
                    />
                    <span className="text-xs truncate text-white/80">{item.title || 'Untitled Chat'}</span>
                  </div>

                  <button 
                    onClick={(e) => onDeleteItem(e, item._id)}
                    className="opacity-100 md:opacity-0 md:group-hover/item:opacity-100 p-1.5 hover:bg-white/10 rounded-md text-white/40 md:text-white/20 hover:text-red-400 transition-all"
                    title="Delete record"
                  >
                    <Trash2 size={14} />
                  </button>
